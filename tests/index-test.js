...
function runSuccessTest(date, expected){
    ...
    describe('formatDate', () => {
        ...
        it('should throw new Error \'Future time\' for date \'2018-04-18T23:09:10.609Z\'', () => {
            const actual= () => formatDate('2018-04-18T23:09:10.609Z');
...
describe('showTweets', () => {
    it('should print date and tweet', () => {
        ...
        formatDate.withArgs('2018-04-17T15:09:10.609Z').returns('вчера в 15:09');
        formatDate.withArgs('2016-03-25T12:00:10.123Z').returns('25.03.2016 в 15:09');
