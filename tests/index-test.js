...
describe('getDate', () => {
    ...
    describe('positiv',() => {
        it('should return `17 марта в 15:09` for 2018-03-25T15:09:10.609Z', () => {
            const fakeDate = new Date(2018, 02, 17, 15, 09);   
