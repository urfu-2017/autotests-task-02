module.exports = function formatDate(date) {
	...
	if (array[0] == dateNow.getUTCFullYear() && dateNow.getUTCMonth()+1==parseInt(array[1])){
		...
		else if (parseInt(array[2]) == dateNow.getUTCDate()-1) return "вчера в "+array[3]+":"+array[4]; 
	}
	if (array[0] == dateNow.getUTCFullYear()) return parseInt(array[2])+" "+months[parseInt(array[1])-1]+" в "+array[3]+":"+array[4]; 
